...
namespace Iwanli\Workbench\Packages;
...
class PackageCreator
{
    ...
    {
        foreach ($this->config->get('workbench.support_directory') as $support) {
    ...
    protected function writeProviderStub(Package $package, $directory, $stub)
    {
        ...
        $file = $path.DIRECTORY_SEPARATOR.$package->name.'ServiceProvider.php';
    ...
    {
        $fullPath = $path.DIRECTORY_SEPARATOR.$package->getFullName();
